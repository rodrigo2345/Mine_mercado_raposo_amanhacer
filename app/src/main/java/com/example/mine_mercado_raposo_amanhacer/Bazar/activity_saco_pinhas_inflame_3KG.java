...
public class activity_saco_pinhas_inflame_3KG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saco_pinhas_inflame3_kg);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Saco de Pinhas Inflame 3KG", "4,95€","" , R.drawable.saco_pinhas_inflame_3kg, 1));
        recyclerView = findViewById(R.id.recyclerView_product66);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_saco_pinhas_inflame_3KG.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_saco_pinhas_inflame_3KG.this, MainActivity.class);
        startActivity(intent);
    }
}
