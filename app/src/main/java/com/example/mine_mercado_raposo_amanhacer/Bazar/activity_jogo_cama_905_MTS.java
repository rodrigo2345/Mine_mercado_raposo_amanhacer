...
public class activity_jogo_cama_905_MTS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo_cama905_mts);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Jogo de Cama 100% 01 REF 905", "39,60€","" , R.drawable.jogo_cama905_mts, 1));
        recyclerView = findViewById(R.id.recyclerView_product92);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_jogo_cama_905_MTS.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_jogo_cama_905_MTS.this, MainActivity.class);
        startActivity(intent);
    }
}
