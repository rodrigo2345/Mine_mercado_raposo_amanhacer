...
public class activity_semente_feijao_trepar_algarve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semente_feijao_trepar_algarve);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Semente Feijao Trepar AlgarveO", "1,90€","" , R.drawable.semente_feijao_trepar_algarve, 1));
        recyclerView = findViewById(R.id.recyclerView_product96);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_semente_feijao_trepar_algarve.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_semente_feijao_trepar_algarve.this, MainActivity.class);
        startActivity(intent);
    }
}
