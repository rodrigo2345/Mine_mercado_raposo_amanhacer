...
public class activity_adubo_azul_quimirraia_1KG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adubo_azul_quimirraia1_kg);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Adubo Azul Quimirraia 1KG", "1,75€","" , R.drawable.adubo_azul_quimirraia1_kg, 1));
        recyclerView = findViewById(R.id.recyclerView_product71);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_adubo_azul_quimirraia_1KG.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_adubo_azul_quimirraia_1KG.this, MainActivity.class);
        startActivity(intent);
    }
}
