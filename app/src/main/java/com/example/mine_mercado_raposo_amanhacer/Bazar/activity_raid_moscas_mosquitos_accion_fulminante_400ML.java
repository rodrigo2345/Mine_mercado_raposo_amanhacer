...
public class activity_raid_moscas_mosquitos_accion_fulminante_400ML extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_raid_moscas_mosquitos_accion_fulminante400_ml);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Raid Moscas Y Mosquitos Accion Fulminante 400ML", "3,99€","" , R.drawable.activity_raid_moscas_mosquitos_accion_fulminante400_ml, 1));
        recyclerView = findViewById(R.id.recyclerView_product99);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_raid_moscas_mosquitos_accion_fulminante_400ML.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_raid_moscas_mosquitos_accion_fulminante_400ML.this, MainActivity.class);
        startActivity(intent);
    }
}
