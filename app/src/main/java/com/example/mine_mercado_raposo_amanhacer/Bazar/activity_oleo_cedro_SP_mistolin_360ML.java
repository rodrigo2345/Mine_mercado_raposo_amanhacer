...
public class activity_oleo_cedro_SP_mistolin_360ML extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oleo_cedro_sp_mistolin360_ml);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Oleo de Cedro SP Mistolin 360ML", "3,60€","" , R.drawable.oleo_cedro_sp_mistolin360_ml, 1));
        recyclerView = findViewById(R.id.recyclerView_product74);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_oleo_cedro_SP_mistolin_360ML.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_oleo_cedro_SP_mistolin_360ML.this, MainActivity.class);
        startActivity(intent);
    }
}
