...
public class activity_tela_laminada_brilho_estampada_3d3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_laminada_brilho_estampada3d3);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Tela Laminada Brilho Estampada 3D3/10 100%PVC", "1,95€","" , R.drawable.tela_laminada_brilho_estampada3d3, 1));
        recyclerView = findViewById(R.id.recyclerView_product87);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_tela_laminada_brilho_estampada_3d3.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_tela_laminada_brilho_estampada_3d3.this, MainActivity.class);
        startActivity(intent);
    }
}
