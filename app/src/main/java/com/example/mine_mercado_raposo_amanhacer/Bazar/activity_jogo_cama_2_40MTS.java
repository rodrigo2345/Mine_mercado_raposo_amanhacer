...
public class activity_jogo_cama_2_40MTS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo_cama240_mts);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Jogo de Cama 100% 01 2,40MTS", "33,60€","" , R.drawable.jogo_cama240_mts, 1));
        recyclerView = findViewById(R.id.recyclerView_product91);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_jogo_cama_2_40MTS.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_jogo_cama_2_40MTS.this, MainActivity.class);
        startActivity(intent);
    }
}
