...
public class activity_saco_lixo_ecolixo_50lt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saco_lixo_ecolixo50lt);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Saco Lixo Ecolixo 50LT", "0,75€","" , R.drawable.saco_lixo_ecolixo50lt, 1));
        recyclerView = findViewById(R.id.recyclerView_product79);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_saco_lixo_ecolixo_50lt.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_saco_lixo_ecolixo_50lt.this, MainActivity.class);
        startActivity(intent);
    }
}
