...
public class activity_insecticida_formigas_bio_fortana_100gr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insecticida_formigas_bio_fortana100gr);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Insecticida Po para Formigas Bio Fortana 100GR", "3,20€","" , R.drawable.insecticida_formigas_bio_fortana100gr, 1));
        recyclerView = findViewById(R.id.recyclerView_product98);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_insecticida_formigas_bio_fortana_100gr.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_insecticida_formigas_bio_fortana_100gr.this, MainActivity.class);
        startActivity(intent);
    }
}
