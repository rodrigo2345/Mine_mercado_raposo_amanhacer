...
public class activity_tinta_branca_sorcor_quimirraia_5LT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tinta_branca_sorcor_quimirraia5_lt);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Tinta Branca Sorcor Quimirraia 5LT", "17,65€","" , R.drawable.tinta_branca_sorcor_quimirraia5_lt, 1));
        recyclerView = findViewById(R.id.recyclerView_product77);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_tinta_branca_sorcor_quimirraia_5LT.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_tinta_branca_sorcor_quimirraia_5LT.this, MainActivity.class);
        startActivity(intent);
    }
}
