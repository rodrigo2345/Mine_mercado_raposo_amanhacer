...
public class activity_limacide_250gr_caracois extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_limacide250gr_caracois);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Limacide 250GR Caracois", "5,85€","" , R.drawable.limacide250gr_caracois, 1));
        recyclerView = findViewById(R.id.recyclerView_product78);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_limacide_250gr_caracois.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_limacide_250gr_caracois.this, MainActivity.class);
        startActivity(intent);
    }
}
