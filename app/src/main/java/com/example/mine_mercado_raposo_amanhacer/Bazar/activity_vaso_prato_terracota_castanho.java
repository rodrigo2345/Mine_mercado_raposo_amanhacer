...
public class activity_vaso_prato_terracota_castanho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vaso_prato_terracota_castanho);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Vaso e Prato Terracota Castanho", "2,00€","" , R.drawable.vaso_prato_terracota_castanho, 1));
        recyclerView = findViewById(R.id.recyclerView_product81);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_vaso_prato_terracota_castanho.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_vaso_prato_terracota_castanho.this, MainActivity.class);
        startActivity(intent);
    }
}
