...
public class activity_garrafa_cepsa extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_garrafa_cepsa.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_garrafa_cepsa.this, MainActivity.class);
        startActivity(intent);
    }
}
