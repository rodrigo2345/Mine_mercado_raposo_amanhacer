...
public class activity_avenal_racao_seca_gato_cereais_carne_4kg extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_avenal_racao_seca_gato_cereais_carne_4kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_avenal_racao_seca_gato_cereais_carne_4kg.this, MainActivity.class);
        startActivity(intent);
    }
}