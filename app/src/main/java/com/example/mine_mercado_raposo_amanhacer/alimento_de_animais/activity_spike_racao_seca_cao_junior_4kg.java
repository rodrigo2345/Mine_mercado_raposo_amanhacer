...
public class activity_spike_racao_seca_cao_junior_4kg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spike_racao_seca_cao_junior4kg);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Spike Racao Seca de Cao Junior 4KG", "7,25€","" , R.drawable.spike_racao_seca_cao_junior_4kg, 1));
        recyclerView = findViewById(R.id.recyclerView_product11);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_spike_racao_seca_cao_junior_4kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_spike_racao_seca_cao_junior_4kg.this, MainActivity.class);
        startActivity(intent);
    }
