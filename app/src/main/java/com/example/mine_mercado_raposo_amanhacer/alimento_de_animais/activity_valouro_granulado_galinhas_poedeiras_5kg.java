...
public class activity_valouro_granulado_galinhas_poedeiras_5kg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valouro_granulado_galinhas_poedeiras5kg);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Valouro Granulado para Galinhas Poedeiras 5KG", "2,95€","" , R.drawable.valouro_galinhas_poedeiras_5kg, 1));

        recyclerView = findViewById(R.id.recyclerView_product5);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_valouro_granulado_galinhas_poedeiras_5kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_valouro_granulado_galinhas_poedeiras_5kg.this, MainActivity.class);
        startActivity(intent);
    }
