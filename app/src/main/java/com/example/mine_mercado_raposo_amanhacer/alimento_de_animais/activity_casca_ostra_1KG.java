...
public class activity_casca_ostra_1KG extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_casca_ostra_1KG.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_casca_ostra_1KG.this, MainActivity.class);
        startActivity(intent);
    }
}
