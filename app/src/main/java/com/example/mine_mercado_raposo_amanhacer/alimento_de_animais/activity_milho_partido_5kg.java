...
public class activity_milho_partido_5kg extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_milho_partido_5kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_milho_partido_5kg.this, MainActivity.class);
        startActivity(intent);
    }
