...
public class activity_milho_partido_25kg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_milho_partido_25kg);

        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Milho Partido 25KG", "11,10€","" , R.drawable.milho_partido_25kg, 1));

        recyclerView = findViewById(R.id.recyclerView_product3);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_milho_partido_25kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_milho_partido_25kg.this, MainActivity.class);
        startActivity(intent);
    }
