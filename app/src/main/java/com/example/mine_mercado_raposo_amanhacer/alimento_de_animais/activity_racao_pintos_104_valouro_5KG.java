...
public class activity_racao_pintos_104_valouro_5KG extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_racao_pintos_104_valouro_5KG.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_racao_pintos_104_valouro_5KG.this, MainActivity.class);
        startActivity(intent);
    }
}
