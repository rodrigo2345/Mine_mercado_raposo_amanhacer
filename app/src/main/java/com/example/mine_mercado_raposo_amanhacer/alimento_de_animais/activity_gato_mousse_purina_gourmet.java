...
public class activity_gato_mousse_purina_gourmet extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_gato_mousse_purina_gourmet.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_gato_mousse_purina_gourmet.this, MainActivity.class);
        startActivity(intent);
    }
}