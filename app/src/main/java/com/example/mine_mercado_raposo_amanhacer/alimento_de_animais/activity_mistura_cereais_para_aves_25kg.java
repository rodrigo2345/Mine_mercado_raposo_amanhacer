...
public class activity_mistura_cereais_para_aves_25kg extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_mistura_cereais_para_aves_25kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_mistura_cereais_para_aves_25kg.this, MainActivity.class);
        startActivity(intent);
    }
