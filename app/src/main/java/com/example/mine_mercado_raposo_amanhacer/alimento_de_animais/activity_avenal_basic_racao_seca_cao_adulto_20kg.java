...
public class activity_avenal_basic_racao_seca_cao_adulto_20kg extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_avenal_basic_racao_seca_cao_adulto_20kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_avenal_basic_racao_seca_cao_adulto_20kg.this, MainActivity.class);
        startActivity(intent);
    }
