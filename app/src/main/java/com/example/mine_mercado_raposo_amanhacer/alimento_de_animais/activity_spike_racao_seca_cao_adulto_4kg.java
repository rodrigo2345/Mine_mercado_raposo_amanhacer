...
public class activity_spike_racao_seca_cao_adulto_4kg extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_spike_racao_seca_cao_adulto_4kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_spike_racao_seca_cao_adulto_4kg.this, MainActivity.class);
        startActivity(intent);
    }
