...
public class activity_mistura_canarios_1KG extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_mistura_canarios_1KG.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_mistura_canarios_1KG.this, MainActivity.class);
        startActivity(intent);
    }
}
