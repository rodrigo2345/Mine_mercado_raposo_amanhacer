...
public class activity_avenal_racao_seca_gato_peixe_2kg extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_avenal_racao_seca_gato_peixe_2kg.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_avenal_racao_seca_gato_peixe_2kg.this, MainActivity.class);
        startActivity(intent);
    }
}
