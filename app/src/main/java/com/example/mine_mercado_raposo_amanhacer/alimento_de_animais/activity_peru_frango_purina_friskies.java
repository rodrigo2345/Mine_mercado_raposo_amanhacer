...
public class activity_peru_frango_purina_friskies extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_peru_frango_purina_friskies.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_peru_frango_purina_friskies.this, MainActivity.class);
        startActivity(intent);
    }
}
