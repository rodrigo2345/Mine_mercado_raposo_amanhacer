...
public class activity_bacon_nacos_200GR extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_bacon_nacos_200GR.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_bacon_nacos_200GR.this, MainActivity.class);
        startActivity(intent);
    }
}
