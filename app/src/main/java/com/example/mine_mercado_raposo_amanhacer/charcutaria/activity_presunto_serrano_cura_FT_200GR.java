...
public class activity_presunto_serrano_cura_FT_200GR extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_presunto_serrano_cura_FT_200GR.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_presunto_serrano_cura_FT_200GR.this, MainActivity.class);
        startActivity(intent);
    }
}
