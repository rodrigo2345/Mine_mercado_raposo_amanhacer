...
public class activity_banha_porco_235GR extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_banha_porco_235GR.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_banha_porco_235GR.this, MainActivity.class);
        startActivity(intent);
    }
}
