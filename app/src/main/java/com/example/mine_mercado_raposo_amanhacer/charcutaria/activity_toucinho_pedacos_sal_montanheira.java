...
public class activity_toucinho_pedacos_sal_montanheira extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_toucinho_pedacos_sal_montanheira.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_toucinho_pedacos_sal_montanheira.this, MainActivity.class);
        startActivity(intent);
    }
}
