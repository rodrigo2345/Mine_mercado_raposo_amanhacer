...
public class activity_campofrio_fiambre_peru_finissimo_FT extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_campofrio_fiambre_peru_finissimo_FT.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_campofrio_fiambre_peru_finissimo_FT.this, MainActivity.class);
        startActivity(intent);
    }
}