...
public class activity_lenco_papel_branco_3f_6un extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lenco_papel_branco3f6un);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Lenco Papel Branco 3F 6UN", "0,78€","" , R.drawable.lenco_papel_branco3f6un, 1));
        recyclerView = findViewById(R.id.recyclerView_product93);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_lenco_papel_branco_3f_6un.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_lenco_papel_branco_3f_6un.this, MainActivity.class);
        startActivity(intent);
    }
}
