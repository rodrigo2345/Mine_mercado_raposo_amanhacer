...
public class activity_garrafa_tuti_11KG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_garrafa_tuti11_kg);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Garrafa Tuti 11KG", "29,50€","" , R.drawable.garrafa_tuti_11kg, 1));
        recyclerView = findViewById(R.id.recyclerView_product52);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_garrafa_tuti_11KG.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_garrafa_tuti_11KG.this, MainActivity.class);
        startActivity(intent);
    }
}
