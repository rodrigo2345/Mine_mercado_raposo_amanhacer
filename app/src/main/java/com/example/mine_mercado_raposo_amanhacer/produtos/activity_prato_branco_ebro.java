...
public class activity_prato_branco_ebro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prato_branco_ebro);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Prato Branco EBRO", "1,80€","" , R.drawable.prato_branco_ebro, 1));
        recyclerView = findViewById(R.id.recyclerView_product95);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_prato_branco_ebro.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_prato_branco_ebro.this, MainActivity.class);
        startActivity(intent);
    }
}
