...
public class activity_linguica_Porco_alentejano_180GR extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_linguica_Porco_alentejano_180GR.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_linguica_Porco_alentejano_180GR.this, MainActivity.class);
        startActivity(intent);
    }
}
