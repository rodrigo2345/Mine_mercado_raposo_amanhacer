...
public class activity_chourico_grosso_porco_preto_estremoz extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_chourico_grosso_porco_preto_estremoz.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_chourico_grosso_porco_preto_estremoz.this, MainActivity.class);
        startActivity(intent);
    }
}
