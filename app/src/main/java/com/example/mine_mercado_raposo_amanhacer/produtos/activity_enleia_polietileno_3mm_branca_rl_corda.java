...
public class activity_enleia_polietileno_3mm_branca_rl_corda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enleia_polietileno3mm_branca_rl_corda);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Enleia Polietileno 3MM Branca RL Corda", "7,15€","Descrição do produto - Preço do Kilo" , R.drawable.enleia_polietileno3mm_branca_rl_corda, 1));
        recyclerView = findViewById(R.id.recyclerView_product89);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_enleia_polietileno_3mm_branca_rl_corda.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_enleia_polietileno_3mm_branca_rl_corda.this, MainActivity.class);
        startActivity(intent);
    }
}
