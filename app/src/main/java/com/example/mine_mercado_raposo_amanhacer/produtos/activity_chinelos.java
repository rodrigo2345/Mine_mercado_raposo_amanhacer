...
public class activity_chinelos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chinelos);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Chinelos", "3,80€","" , R.drawable.chinelos, 1));
        recyclerView = findViewById(R.id.recyclerView_product100);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_chinelos.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_chinelos.this, MainActivity.class);
        startActivity(intent);
    }
}
