...
public class activity_feijao_verde_rasteiro_patareco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feijao_verde_rasteiro_patareco);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Feijao Verde Rasteiro Patareco", "1,90€","" , R.drawable.feijao_verde_rasteiro_patareco, 1));
        recyclerView = findViewById(R.id.recyclerView_product97);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_feijao_verde_rasteiro_patareco.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_feijao_verde_rasteiro_patareco.this, MainActivity.class);
        startActivity(intent);
    }
}
