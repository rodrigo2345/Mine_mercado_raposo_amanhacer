...
public class activity_passadeira_belga_C_Debrum_Poliamida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passadeira_belga_cdebrum_poliamida);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Passadeira Belga C/Debrum 100%Poliamida", "10,35€","" , R.drawable.passadeira_belga_cdebrum_poliamida, 1));
        recyclerView = findViewById(R.id.recyclerView_product90);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_passadeira_belga_C_Debrum_Poliamida.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_passadeira_belga_C_Debrum_Poliamida.this, MainActivity.class);
        startActivity(intent);
    }
}
