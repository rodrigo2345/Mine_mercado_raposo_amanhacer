...
public class activity_farinheira_branca_porco_branco extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_farinheira_branca_porco_branco.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_farinheira_branca_porco_branco.this, MainActivity.class);
        startActivity(intent);
    }
}
