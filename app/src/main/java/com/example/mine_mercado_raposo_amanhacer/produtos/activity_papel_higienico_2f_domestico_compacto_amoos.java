...
public class activity_papel_higienico_2f_domestico_compacto_amoos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papel_higienico2f_domestico_compacto_amoos);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Papel Higienico 2F Domestico Compacto 12=24 P96R Amoos", "5,99€","" , R.drawable.papel_higienico2f_domestico_compacto_amoos, 1));
        recyclerView = findViewById(R.id.recyclerView_product82);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_papel_higienico_2f_domestico_compacto_amoos.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_papel_higienico_2f_domestico_compacto_amoos.this, MainActivity.class);
        startActivity(intent);
    }
}
