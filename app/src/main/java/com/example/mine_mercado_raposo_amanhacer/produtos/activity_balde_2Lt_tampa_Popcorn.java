...
public class activity_balde_2Lt_tampa_Popcorn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_balde2_lt_tampa_popcorn);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Balde 2LT com Tampa Popcorn/250", "2,25€","" , R.drawable.balde2_lt_tampa_popcorn, 1));
        recyclerView = findViewById(R.id.recyclerView_product80);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_balde_2Lt_tampa_Popcorn.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_balde_2Lt_tampa_Popcorn.this, MainActivity.class);
        startActivity(intent);
    }
}
