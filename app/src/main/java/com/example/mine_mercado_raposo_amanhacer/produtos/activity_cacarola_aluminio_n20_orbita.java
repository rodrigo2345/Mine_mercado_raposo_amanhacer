...
public class activity_cacarola_aluminio_n20_orbita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cacarola_aluminio_n20_orbita);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Cacarola de Aluminio n20 Orbita", "12,05€","" , R.drawable.cacarola_aluminio_n20_orbita, 1));
        recyclerView = findViewById(R.id.recyclerView_product84);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_cacarola_aluminio_n20_orbita.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_cacarola_aluminio_n20_orbita.this, MainActivity.class);
        startActivity(intent);
    }
}
