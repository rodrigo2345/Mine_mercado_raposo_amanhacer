...
public class activity_velas_iluminacao_v7_lumar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_velas_iluminacao_v7_lumar);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Velas de Iluminacao V7 Lumar", "1,75€","" , R.drawable.velas_iluminacao_v7_lumar, 1));
        recyclerView = findViewById(R.id.recyclerView_product67);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_velas_iluminacao_v7_lumar.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_velas_iluminacao_v7_lumar.this, MainActivity.class);
        startActivity(intent);
    }
}
