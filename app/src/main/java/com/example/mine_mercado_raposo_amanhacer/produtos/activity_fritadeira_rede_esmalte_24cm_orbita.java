...
public class activity_fritadeira_rede_esmalte_24cm_orbita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fritadeira_rede_esmalte24cm_orbita);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Fritadeira com Rede Esmalte 24CM Orbita", "16,35€","" , R.drawable.fritadeira_rede_esmalte24cm_orbita, 1));
        recyclerView = findViewById(R.id.recyclerView_product86);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_fritadeira_rede_esmalte_24cm_orbita.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_fritadeira_rede_esmalte_24cm_orbita.this, MainActivity.class);
        startActivity(intent);
    }
}
