...
public class activity_nobre_fiambre_fatias_finas_100GR extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_nobre_fiambre_fatias_finas_100GR.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_nobre_fiambre_fatias_finas_100GR.this, MainActivity.class);
        startActivity(intent);
    }
}
