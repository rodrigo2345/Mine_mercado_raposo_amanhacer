...
public class activity_trincha_junior extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trincha_junior);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Trincha Junior 21/2", "4,15€","" , R.drawable.trincha_junior, 1));
        recyclerView = findViewById(R.id.recyclerView_product70);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_trincha_junior.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_trincha_junior.this, MainActivity.class);
        startActivity(intent);
    }
}
