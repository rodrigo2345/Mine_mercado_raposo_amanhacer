...
public class activity_bolo_forma_mel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolo_forma_mel);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Bolo Forma de Mel", "2,45€","" , R.drawable.bolo_forma_mel, 1));
        recyclerView = findViewById(R.id.recyclerView_product56);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_bolo_forma_mel.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_bolo_forma_mel.this, MainActivity.class);
        startActivity(intent);
    }
}
