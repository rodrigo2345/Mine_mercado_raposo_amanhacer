...
public class activity_queijada_requeijao extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_queijada_requeijao.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_queijada_requeijao.this, MainActivity.class);
        startActivity(intent);
    }
}
