...
public class activity_bolo_forma_laranja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolo_forma_laranja);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Bolo Forma de Laranja", "2,45€","" , R.drawable.bolo_forma_laranja, 1));
        recyclerView = findViewById(R.id.recyclerView_product58);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_bolo_forma_laranja.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_bolo_forma_laranja.this, MainActivity.class);
        startActivity(intent);
    }
}
