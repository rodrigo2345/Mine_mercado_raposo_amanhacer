...
public class activity_bolo_forma_noz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolo_forma_noz);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Bolo Forma de Noz", "2,45€","" , R.drawable.bolo_forma_noz, 1));
        recyclerView = findViewById(R.id.recyclerView_product59);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_bolo_forma_noz.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_bolo_forma_noz.this, MainActivity.class);
        startActivity(intent);
    }
}
