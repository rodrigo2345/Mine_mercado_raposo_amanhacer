...
public class activity_esses_azeite extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_esses_azeite.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_esses_azeite.this, MainActivity.class);
        startActivity(intent);
    }
}
