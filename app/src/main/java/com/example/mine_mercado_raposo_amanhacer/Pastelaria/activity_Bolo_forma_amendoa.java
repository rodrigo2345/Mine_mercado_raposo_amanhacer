package com.example.mine_mercado_raposo_amanhacer.Pastelaria;
...
public class activity_Bolo_forma_amendoa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolo_forma_amendoa);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Bolo Forma de Amendoa", "2,45€","" , R.drawable.bolo_forma_amendoa, 1));
        recyclerView = findViewById(R.id.recyclerView_product57);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_Bolo_forma_amendoa.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_Bolo_forma_amendoa.this, MainActivity.class);
        startActivity(intent);
    }
}
