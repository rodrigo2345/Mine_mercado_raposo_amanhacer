...
public class activity_pepsi_regular extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_pepsi_regular.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_pepsi_regular.this, MainActivity.class);
        startActivity(intent);
    }
}
