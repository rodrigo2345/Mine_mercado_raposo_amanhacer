package com.example.mine_mercado_raposo_amanhacer.bebidas;
...
public class activity_sumo_amigo_morango_200ML extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_sumo_amigo_morango_200ML.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_sumo_amigo_morango_200ML.this, MainActivity.class);
        startActivity(intent);
    }
}
