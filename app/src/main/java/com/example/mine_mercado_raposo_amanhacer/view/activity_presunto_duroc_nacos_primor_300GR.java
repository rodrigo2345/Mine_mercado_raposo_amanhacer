...
public class activity_presunto_duroc_nacos_primor_300GR extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_presunto_duroc_nacos_primor_300GR.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_presunto_duroc_nacos_primor_300GR.this, MainActivity.class);
        startActivity(intent);
    }
}
