...
public class activity_fiambre_frango_FT_classicas_90GR extends AppCompatActivity {
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_fiambre_frango_FT_classicas_90GR.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_fiambre_frango_FT_classicas_90GR.this, MainActivity.class);
        startActivity(intent);
    }
}
