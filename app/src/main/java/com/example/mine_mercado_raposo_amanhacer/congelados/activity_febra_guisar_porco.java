...
public class activity_febra_guisar_porco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_febra_guisar_porco);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Febra de Guisar de Porco", "7,95€","Descrição do produto - Preço do Kilo" , R.drawable.febra_guisar_porco, 1));
        recyclerView = findViewById(R.id.recyclerView_product114);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_febra_guisar_porco.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_febra_guisar_porco.this, MainActivity.class);
        startActivity(intent);
    }
}
