...
public class activity_pescada_posta_congelada_higien extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pescada_posta_congelada_higien);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Pescada em Posta Congelada Higien", "6,35€","Descrição do produto - Preço do Kilo" , R.drawable.pescada_posta_congelada_higien, 1));
        recyclerView = findViewById(R.id.recyclerView_product104);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_pescada_posta_congelada_higien.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_pescada_posta_congelada_higien.this, MainActivity.class);
        startActivity(intent);
    }
}
