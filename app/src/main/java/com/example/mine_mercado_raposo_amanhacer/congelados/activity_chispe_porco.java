...
public class activity_chispe_porco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chispe_porco);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Chispe de Porco", "4,85€","Descrição do produto - Preço do Kilo" , R.drawable.chispe_porco, 1));
        recyclerView = findViewById(R.id.recyclerView_product115);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_chispe_porco.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_chispe_porco.this, MainActivity.class);
        startActivity(intent);
    }
}
