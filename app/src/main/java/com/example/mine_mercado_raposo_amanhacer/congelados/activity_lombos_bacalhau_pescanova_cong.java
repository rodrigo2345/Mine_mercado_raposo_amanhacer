...
public class activity_lombos_bacalhau_pescanova_cong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lombos_bacalhau_pescanova_cong);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Lombos de Bacalhau Pescanova Cong", "21,06€","Descrição do produto - Preço do Kilo" , R.drawable.lombos_bacalhau_pescanova_cong, 1));
        recyclerView = findViewById(R.id.recyclerView_product106);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_lombos_bacalhau_pescanova_cong.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_lombos_bacalhau_pescanova_cong.this, MainActivity.class);
        startActivity(intent);
    }
}
