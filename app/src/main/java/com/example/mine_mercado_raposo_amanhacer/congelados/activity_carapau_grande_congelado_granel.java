...
public class activity_carapau_grande_congelado_granel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carapau_grande_congelado_granel);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Carapau Grande Congelado a Granel", "2,76€","Descrição do produto - Preço do Kilo" , R.drawable.carapau_grande_congelado_granel, 1));
        recyclerView = findViewById(R.id.recyclerView_product103);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_carapau_grande_congelado_granel.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_carapau_grande_congelado_granel.this, MainActivity.class);
        startActivity(intent);
    }
}
