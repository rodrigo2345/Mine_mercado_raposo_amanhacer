...
public class activity_peixe_espada_branco_posta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peixe_espada_branco_posta);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Peixe Espada Branco Posta", "10,40€","Descrição do produto - Preço do Kilo" , R.drawable.peixe_espada_branco_posta, 1));
        recyclerView = findViewById(R.id.recyclerView_product109);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_peixe_espada_branco_posta.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_peixe_espada_branco_posta.this, MainActivity.class);
        startActivity(intent);
    }
}
