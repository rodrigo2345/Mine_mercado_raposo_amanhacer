...
public class activity_bife_porco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bife_porco);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Bife de Porco", "8,95€","Descrição do produto - Preço do Kilo" , R.drawable.bife_porco, 1));
        recyclerView = findViewById(R.id.recyclerView_product113);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_bife_porco.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_bife_porco.this, MainActivity.class);
        startActivity(intent);
    }
}
