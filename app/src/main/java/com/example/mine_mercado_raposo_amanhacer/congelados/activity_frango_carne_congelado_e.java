...
public class activity_frango_carne_congelado_e extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frango_carne_congelado_e);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Frango Carne Congelado E", "4,75€","Descrição do produto - Preço do Kilo" , R.drawable.frango_carne_congelado_e, 1));
        recyclerView = findViewById(R.id.recyclerView_product117);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_frango_carne_congelado_e.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_frango_carne_congelado_e.this, MainActivity.class);
        startActivity(intent);
    }
}
