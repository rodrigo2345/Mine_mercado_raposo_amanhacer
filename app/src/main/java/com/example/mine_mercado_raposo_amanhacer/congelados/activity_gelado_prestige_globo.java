...
public class activity_gelado_prestige_globo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gelado_prestige_globo);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Gelado Prestige Globo", "2,55€","" , R.drawable.gelado_prestige_globo, 1));
        recyclerView = findViewById(R.id.recyclerView_product123);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_gelado_prestige_globo.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_gelado_prestige_globo.this, MainActivity.class);
        startActivity(intent);
    }
}
