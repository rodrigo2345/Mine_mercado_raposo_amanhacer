...
public class activity_gelado_coppeti_globo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gelado_coppeti_globo);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Gelado Coppeti Globo", "0,80€","" , R.drawable.gelado_coppeti_globo, 1));
        recyclerView = findViewById(R.id.recyclerView_product122);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_gelado_coppeti_globo.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_gelado_coppeti_globo.this, MainActivity.class);
        startActivity(intent);
    }
}
