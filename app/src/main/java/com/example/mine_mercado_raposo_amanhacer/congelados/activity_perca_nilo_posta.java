...
public class activity_perca_nilo_posta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perca_nilo_posta);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Perca do Nilo Posta", "10,50€","Descrição do produto - Preço do Kilo" , R.drawable.perca_nilo_posta, 1));
        recyclerView = findViewById(R.id.recyclerView_product110);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_perca_nilo_posta.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_perca_nilo_posta.this, MainActivity.class);
        startActivity(intent);
    }
}
