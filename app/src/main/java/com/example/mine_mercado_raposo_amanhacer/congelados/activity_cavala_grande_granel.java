...
public class activity_cavala_grande_granel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cavala_grande_granel);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Cavala Grande Granel", "2,85€","Descrição do produto - Preço do Kilo" , R.drawable.cavala_grande_granel, 1));
        recyclerView = findViewById(R.id.recyclerView_product108);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_cavala_grande_granel.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_cavala_grande_granel.this, MainActivity.class);
        startActivity(intent);
    }
}
