...
public class activity_sardinha_congelada_granel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sardinha_congelada_granel);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Sardinha Congelada a Granel", "4,75€","Descrição do produto - Preço do Kilo" , R.drawable.sardinha_congelada_granel, 1));
        recyclerView = findViewById(R.id.recyclerView_product102);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_sardinha_congelada_granel.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_sardinha_congelada_granel.this, MainActivity.class);
        startActivity(intent);
    }
}
