...
public class activity_filete_pescada_comdalgel_cong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filete_pescada_comdalgel_cong);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Filete de Pescada Comdalgel Cong", "10,35€","Descrição do produto - Preço do Kilo" , R.drawable.filete_pescada_comdalgel_cong, 1));
        recyclerView = findViewById(R.id.recyclerView_product107);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_filete_pescada_comdalgel_cong.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_filete_pescada_comdalgel_cong.this, MainActivity.class);
        startActivity(intent);
    }
}
