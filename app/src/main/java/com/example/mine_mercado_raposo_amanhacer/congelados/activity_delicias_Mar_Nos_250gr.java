...
public class activity_delicias_Mar_Nos_250gr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delicias_mar_nos250gr);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Delicias do Mar Nos 250GR", "1,70€","" , R.drawable.delicias_mar_nos250gr, 1));
        recyclerView = findViewById(R.id.recyclerView_product120);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_delicias_Mar_Nos_250gr.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_delicias_Mar_Nos_250gr.this, MainActivity.class);
        startActivity(intent);
    }
}
