...
public class activity_entremeada_porco_fatiada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entremeada_porco_fatiada);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Entremeada de Porco Fatiada", "8,40€","Descrição do produto - Preço do Kilo" , R.drawable.entremeada_porco_fatiada, 1));
        recyclerView = findViewById(R.id.recyclerView_product116);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_entremeada_porco_fatiada.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_entremeada_porco_fatiada.this, MainActivity.class);
        startActivity(intent);
    }
}
