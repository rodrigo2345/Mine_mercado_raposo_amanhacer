...
public class activity_red_fish_medio_hig extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_fish_medio_hig);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Red Fish Medio Hig", "6,95€","Descrição do produto - Preço do Kilo" , R.drawable.red_fish_medio_hig, 1));
        recyclerView = findViewById(R.id.recyclerView_product101);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_red_fish_medio_hig.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_red_fish_medio_hig.this, MainActivity.class);
        startActivity(intent);
    }
}
