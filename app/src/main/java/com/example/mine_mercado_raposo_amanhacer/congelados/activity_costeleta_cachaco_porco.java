...
public class activity_costeleta_cachaco_porco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_costeleta_cachaco_porco);
        List<Contact> contactList = new ArrayList<>();
        contactList.add(new Contact("Costeleta Cachaco de Porco", "8,57€","Descrição do produto - Preço do Kilo" , R.drawable.costeleta_cachaco_porco, 1));
        recyclerView = findViewById(R.id.recyclerView_product112);
    ...
    public void Search(View view) {
        Intent intent = new Intent(activity_costeleta_cachaco_porco.this, PesquisaActivity.class);
        startActivity(intent);
    }

    public void Home(View view) {
        Intent intent = new Intent(activity_costeleta_cachaco_porco.this, MainActivity.class);
        startActivity(intent);
    }
}
